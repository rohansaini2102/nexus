        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul>
                <li className="mb-2">
                  <a href="#products" className="hover:underline text-gray-300">Products</a>
                </li>
                <li className="mb-2">
                  <a href="#testimonials" className="hover:underline text-gray-300">Testimonials</a>
                </li>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-2">Email: <a href="mailto:info@yourcompany.com" className="hover:underline">nexustoolsbox@gmail.com</a></p>
              <p className="text-gray-300 mb-2">Phone: <a href="tel:+1234567890" className="hover:underline">+91 82395 55834</a></p>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {/* Facebook */}
                <a href="https://www.instagram.com/nexustoolbox/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
